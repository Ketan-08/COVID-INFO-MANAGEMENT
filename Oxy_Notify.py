...
class Oxy_Notify:
    def __init__(self):
        ...
        n=StringVar()
        cBox=ttk.Combobox(w4,width=40,textvariable=n,font=("Helvetica",15,"bold"))
        ...
        def Info():
            ...
            c.execute("""Insert into notify_oxy values (%s,%s,%s)""",(l,m,n))
            conn.commit()
        ...
        b1=Button(w4,text="NOTIFY ME",width=10,font='Calibri,15',bg='YELLOW',command=Info)
