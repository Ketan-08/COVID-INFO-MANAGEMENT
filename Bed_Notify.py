...
class Bed_Notify:
    def __init__(self):
        ...
        b1=Button(w3,text="NOTIFY ME",width=10,font='Calibri,15',bg='YELLOW',command=Msg)
        
        n=StringVar()
        c=ttk.Combobox(w3,width=40,textvariable=n,font=("Helvetica",15,"bold"))
...
def combo_input(self):
            ...
            c.execute('SELECT Name from hos_bed')
